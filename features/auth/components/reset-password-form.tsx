...
import { resetPasswordAction, type ResetPasswordState } from '@/features/auth/actions/auth.actions';
        ...
        <div className='w-full max-w-md'>
          ...
          {!token ? (
            ...
            <div className='space-y-6'>
              <div className='border-destructive/30 bg-destructive/10 text-destructive rounded-lg border p-4 text-sm flex items-start gap-3'>
                <Icons.warning className='mt-0.5 shrink-0 size-5' />
                <div className='space-y-1'>
                  <p className='font-semibold'>Mã xác thực không hợp lệ</p>
                  <p>Liên kết đặt lại mật khẩu thiếu mã xác thực (token) hoặc không hợp lệ. Vui lòng kiểm tra lại email hoặc yêu cầu liên kết mới.</p>
                </div>
              </div>
              ...
              <div className='flex flex-col gap-3'>
                ...
                <Button asChild variant='outline' className='w-full h-11 font-semibold text-base'>
            ...
            <div className='space-y-6'>
              <div className='border-emerald-500/30 bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 rounded-lg border p-4 text-sm flex items-start gap-3'>
                ...
                <div className='space-y-1.5'>
                  ...
                  <p>{state.message || "Mật khẩu của bạn đã được đặt lại thành công. Bây giờ bạn có thể đăng nhập bằng mật khẩu mới."}</p>
                </div>
              </div>
              ...
              <div className='space-y-1.5'>
                ...
                <div className='relative'>
                  ...
                  <button
                    ...
                    tabIndex={-1}
                  >
                    {showConfirmPassword ? <Icons.eyeOff size={22} /> : <Icons.eye size={22} />}
                  </button>
                </div>
              </div>
